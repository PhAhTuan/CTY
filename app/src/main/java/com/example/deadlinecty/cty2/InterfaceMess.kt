    ...
    fun HomeScreenTN(groupChat: DataChat, navController: NavController, messageViewModel: MessageViewModel = viewModel()) {
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            BodyTN(
                ...
                onDelete = { messageViewModel.deleteMessage(groupChat.conversationId, it) },
    ...
    fun HeadTN(groupChat: DataChat, navController: NavController){
        ...
        fun BodyTN(
            ...
            LazyColumn(
                ...
                items(tinNhanList) { tin ->
                    TinNhanItem(tin, onDelete)
                }
            }
    ...
    @Composable
    fun TinNhanItem(tin: TinNhan, onDelete: (TinNhan) -> Unit) {
        ...
        Column(
            horizontalAlignment = if (tin.isMine) Alignment.End else Alignment.Start,
            modifier = Modifier
                .fillMaxWidth()
            ...
            Box(
                modifier = Modifier
                    .background(
                        if (tin.isMine) Color(0xFFDCF8C6) else Color(0xFFFFFFFF),
                ...
                Column {
                    ...
                    tin.audioUrl?.let {
                        Spacer(modifier = Modifier.height(4.dp))
                        Text("Ghi âm: ${it.substringAfterLast("/")}", color = Color.Blue)
                    }
